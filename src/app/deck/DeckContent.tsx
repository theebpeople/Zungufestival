  ...
  return (
    <div style={{ backgroundColor: bg, color: cream, fontFamily: fontMono, position: 'relative', width: '100%', minHeight: '100vh' }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <strong style={{ color: cream }}>Where the magic of sound, sea, sand, movement, and Caribbean rhythm invites you into the ultimate electronic music experience.</strong>
          </p>
      ...
      <Section id="section-brand">
        <SectionHead label="The Brand Thesis" title="Jamaica shaped the DNA of global electronic music." />
        <div style={{ maxWidth: 880, marginBottom: 32 }}>
          {[
            { text: 'From sound systems to dub, dancehall, bass culture, remix culture, MC culture, jungle, drum and bass, dubstep, and global club music — Jamaica\'s influence has moved through the world for decades.', weight: 300 },
            { text: 'Zungu brings that movement home.', weight: 300 },
            { text: 'Not as nostalgia. Not as a lecture. As a festival.', weight: 300 },
            { text: 'A Jamaican-born electronic music destination built for the world.', weight: 400 },
          ].map(({ text, weight }) => (
            <p
              key={text}
              style={{
      ...
      <Section id="section-why">
        ...
        <BodyText>
          Because the world already moves to Jamaica. Jamaican sound-system culture changed how music is played, felt, remixed, performed, and experienced. That influence moved outward — through dancehall, dub, hip-hop, jungle, drum and bass, dubstep, grime, bass culture, and global electronic music. Zungu brings the world back to the source.
        </BodyText>
      ...
      <ChapterDivider
        ...
        eye="Chapter Five"
        title="The Model."
        sub="How the festival generates revenue across multiple lines from a single controlled-capacity event."
      />
