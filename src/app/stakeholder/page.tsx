  ...
  return (
    <div style={{ backgroundColor: BG, minHeight: '100vh', fontFamily: MONO, color: CREAM }}>
      ...
      <section id="hero" style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, letterSpacing: '0.04em', lineHeight: 1.8, marginBottom: 48, maxWidth: 520 }}>
            A proposed international electronic music festival on a 64-acre island in Port Antonio Harbour. This brief sets out the site context, community benefit model, and institutional considerations.
          </p>
          ...
          <div style={{ display: 'flex', gap: 0, borderTop: `1px solid rgba(200,168,75,0.2)`, paddingTop: 24, flexWrap: 'wrap' }}>
            {[
              ...
              { label: 'STAKEHOLDER REVIEW', value: 'Open dialogue' },
            ].map((s, i, arr) => (
      ...
      <ChapterDivider
        ...
        title="What Zungu Is."
        sub="Zungu is a proposed international electronic music festival on Navy Island. Port Antonio is the community context."
      />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 48, alignItems: 'start' }}>
            <div>
              ...
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9 }}>
                The festival is rooted in Port Antonio. Every marine operator, food vendor, cultural participant, and site-services provider is sourced from Portland Parish first. The island creates the experience. The town provides the infrastructure.
              </p>
            </div>
            <FactCard rows={[
        ...
        <div style={{ padding: '80px 8vw', position: 'relative' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 48, alignItems: 'start' }}>
            <div>
              ...
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9, marginBottom: 20 }}>
                The Zungu model is structured so that local operators are not peripheral to the festival — they are the festival's infrastructure. Marine transfer, catering, workforce, accommodation, cultural programming, and site services are all defined as Portland Parish participation first.
              </p>
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9 }}>
        ...
        <div style={{ padding: '80px 8vw', position: 'relative' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 48, alignItems: 'start' }}>
            <div>
              ...
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9 }}>
                Site use is subject to the relevant permitting, environmental review, and stakeholder approval processes. Zungu supports full engagement with those processes before any activation proceeds.
              </p>
            </div>
            <FactCard rows={[
              ...
              { l: 'Environmental', v: 'Environmental review to be completed' },
            ]} />
          </div>
        </div>
      </ChapterSection>
      ...
      <ChapterSection id="experience" bg={GREEN} photo="/photos/zungu-glamping-luxe.png">
        <div style={{ padding: '80px 8vw', position: 'relative' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 48, alignItems: 'start' }}>
            <div>
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9, marginBottom: 20 }}>
                Zungu is structured as a week-long event, not a day-trip or weekend festival. The guest model is built on extended dwell: guests arrive in Port Antonio, cross to the island by marine transfer, stay on-site in luxury temporary accommodation, and use the town and wider Portland Parish throughout the week.
              </p>
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9, marginBottom: 20 }}>
              ...
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9 }}>
                This is not a contained festival that tourists pass through. It is a format that puts international visitors inside Port Antonio for a full week.
              </p>
            </div>
            <FactCard rows={[
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 48, alignItems: 'start' }}>
            ...
            <div>
              <div style={{ backgroundColor: 'rgba(0,0,0,0.4)', border: `1px solid ${BORDER_MID}`, borderTop: `3px solid ${GOLD}`, padding: '1.5rem' }}>
                ...
                <p style={{ fontFamily: MONO, fontSize: 12, color: MUTED, lineHeight: 1.7, marginBottom: 4 }}>
                  Target stay pattern: full festival week.
                </p>
                <p style={{ fontFamily: MONO, fontSize: 12, color: MUTED, lineHeight: 1.7, marginBottom: 20 }}>
                  Typical travel group assumption: 2–4 guests.
                </p>
      ...
      <ChapterSection id="review" bg={GREEN} photo="/photos/navy-island-stage-map.png">
        <div style={{ padding: '80px 8vw', position: 'relative' }}>
          ...
          <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.8, maxWidth: 500, marginBottom: 48 }}>
            Zungu is seeking early dialogue. Site use, operating hours, sound direction, access, emergency planning, and environmental protocol are all subject to the relevant institutional review.
          </p>

          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 48, alignItems: 'start' }}>
            <div>
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9, marginBottom: 20 }}>
                The project is being prepared for early stakeholder dialogue. Site use, temporary structure permissions, environmental review, marine access coordination, sound management, operating hours, emergency planning, and demobilisation are all areas requiring engagement with the relevant authorities before activation proceeds.
              </p>
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9, marginBottom: 20 }}>
                Zungu welcomes community consultation as part of the approval process. The organisers are committed to open engagement with Port Antonio residents, community organisations, and local representatives.
              </p>
              <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.9 }}>
                No activation occurs before the review process is complete. This brief is the beginning of that conversation, not the end.
              </p>
            </div>
            <div>
              <div style={{ backgroundColor: 'rgba(0,0,0,0.4)', border: `1px solid ${BORDER_MID}`, borderTop: `3px solid ${GOLD}`, padding: '1.5rem' }}>
                <p style={{ fontFamily: MONO, fontSize: 9, letterSpacing: '0.3em', textTransform: 'uppercase' as const, color: GOLD, fontWeight: 700, marginBottom: 16 }}>Review Areas</p>
                {[
                  { area: 'Site use / permitting', status: 'Subject to relevant authority approval' },
                  { area: 'Environmental review', status: 'EIA scope to be determined' },
                  { area: 'Marine access', status: 'Port Authority · Coast Guard coordination' },
                  { area: 'Sound / operating hrs', status: 'Subject to local authority agreement' },
                  { area: 'Emergency access', status: 'Emergency services route planning required' },
                  { area: 'Community engagement', status: 'Open to community consultation process' },
                  { area: 'Demobilisation plan', status: 'Full site clearance post-event' },
                ].map(({ area, status }) => (
      ...
      <ChapterSection id="contact" bg={BG}>
        <div style={{ padding: '80px 8vw' }}>
          ...
          <p style={{ fontFamily: MONO, fontSize: 15, color: MUTED, lineHeight: 1.8, maxWidth: 480, marginBottom: 40 }}>
            Zungu is seeking early dialogue with institutional, tourism, environmental, marine, community, and public-sector stakeholders to understand review requirements, approval pathways, and areas of alignment.
          </p>

          <a
            href="mailto:stakeholders@zungufestival.com"
            style={{
          ...
          <div style={{ display: 'inline-block', marginLeft: 16 }}>
            <span style={{ fontFamily: MONO, fontSize: 10, letterSpacing: '0.35em', textTransform: 'uppercase' as const, color: GOLD, border: `1px solid ${GOLD_DIM}`, padding: '4px 10px', fontWeight: 700 }}>
              Institutional Stakeholder
            </span>
          </div>
