<<<<<<< HEAD
[README.md](https://github.com/user-attachments/files/27228601/README.md)
...
**Find the primary design file under `zungu-festival-design-system/project/` and read it top to bottom.** Then **follow its imports**: open every file it pulls in (shared components, CSS, scripts) so you understand how the pieces fit together before you start implementing.
...
- `zungu-festival-design-system/README.md` — this file
- `zungu-festival-design-system/project/` — the `Zungu Festival Design System` project files (HTML prototypes, assets, components)
>>>>>>> 41def6f (Initial commit - Zungu festival design system)
